  ...
  return (
    <div>
      <header className="header">
        ...
        <img src="imgProjet/profil.png" alt="Profile" className="profile-pic" />
        <span className="trainer-name">Nom du formateur</span>
        <button className="deconnexion" onClick={f1}>Déconnexion</button>
      </header>
      ...
      <nav className="navigation">
        <button className="menu-button">Gestion des utilisateurs</button>
